...
CREATE TABLE IF NOT EXISTS user_provider_config (
    ...
    asr_region  VARCHAR(32)  DEFAULT NULL  COMMENT 'ASR Azure区域(如 eastasia)',
    ...
    tts_region  VARCHAR(32)  DEFAULT NULL  COMMENT 'TTS Azure区域(如 eastasia)',
    ...
    llm_region  VARCHAR(32)  DEFAULT NULL  COMMENT 'LLM Azure区域(如 eastasia)',
    created_at  DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    updated_at  DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    UNIQUE KEY uk_user_id (user_id)
...
CREATE TABLE IF NOT EXISTS interview_session (
    ...
    interview_type  VARCHAR(32)  DEFAULT 'general' COMMENT '面试类型: technical/hr/english/general/dynamic',
    started_at      DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '开始时间',
    ended_at        DATETIME     DEFAULT NULL COMMENT '结束时间',
    paused_at       DATETIME     DEFAULT NULL COMMENT '暂停时间（用户退出但未结束面试时记录）',
    current_stage   VARCHAR(32)  DEFAULT 'warmup' COMMENT '当前面试阶段: warmup/technical/pressure',
    stage_round     INT          DEFAULT 0 COMMENT '当前阶段内的轮次(0开始)',
